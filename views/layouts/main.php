    ...
    <header>
        ...
        echo Nav::widget([
            ...
            'items' => [
                ...
                ['label' => 'Запросы', 'items' => [
                    ['label' => 'Запрос 1', 'url' => ['/', 'tag' => 'zap1']],
                    ['label' => 'Запрос 2', 'url' => ['/', 'tag' => 'zap2']],
                    ['label' => 'Запрос 3', 'url' => ['/', 'tag' => 'zap3']],
                    ['label' => 'Запрос 4', 'url' => ['/', 'tag' => 'zap4']],
                    ['label' => 'Запрос 5', 'url' => ['/', 'tag' => 'zap5']],
                    ['label' => 'Запрос 6', 'url' => ['/', 'tag' => 'zap6']],
                    ['label' => 'Запрос 7', 'url' => ['/', 'tag' => 'zap7']],
                    ['label' => 'Запрос 8', 'url' => ['/', 'tag' => 'zap8']],
                    ['label' => 'Запрос 9', 'url' => ['/', 'tag' => 'zap9']],
                    ['label' => 'Запрос 10', 'url' => ['/', 'tag' => 'zap10']],
                    ['label' => 'Запрос 11', 'url' => ['/', 'tag' => 'zap11']],
                    ['label' => 'Запрос 12', 'url' => ['/', 'tag' => 'zap12']],
                    ['label' => 'Запрос 13', 'url' => ['/', 'tag' => 'zap13']],
                    ['label' => 'Запрос 14', 'url' => ['/', 'tag' => 'zap14']],
                ]],
                ['label' => 'Таблицы', 'items' => [
